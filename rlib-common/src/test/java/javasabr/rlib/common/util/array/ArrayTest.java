...
public class ArrayTest extends BaseTest {
  ...
  void removeIfTest() {
    ...
    Assertions.assertTrue(array.removeIfConverted(5, Integer::parseInt, Integer::equals));
  ...
  void toArrayTest() {
    ...
    Assertions.assertArrayEquals(ArrayFactory.toArray("First", "Second", "Third", "  "), array.toArray());

    Assertions.assertArrayEquals(ArrayFactory.toArray("First", "Second", "Third", "  "), array.toArray(String.class));

    Assertions.assertArrayEquals(ArrayFactory.toArray("First", "Second", "Third", "  "), array.toArray(new String[0]));
  ...
  void removeTest() {
    ...
    Assertions.assertArrayEquals(ArrayFactory.toArray("First", "Third", "  "), array.toArray());
    ...
    Assertions.assertArrayEquals(ArrayFactory.toArray("Third"), array.toArray());
  ...
  void findAnyTest() {
    ...
    Assertions.assertNull(array.findAny(
        Type1.EXAMPLE, (arg, element) -> {
          assertType(arg, Type1.class);
          assertType(element, String.class);
          return false;
    ...
    Assertions.assertNull(array.findAnyR(
        Type1.EXAMPLE, (element, arg) -> {
          assertType(element, String.class);
          assertType(arg, Type1.class);
          return false;
        }));
    ...
    Assertions.assertNull(array.findAny(
        Type1.EXAMPLE, Type2.EXAMPLE, (arg1, arg2, element) -> {
    ...
    Assertions.assertNotNull(array.findAny(
        "First",
        "Second",
        (first, second, element) -> first.equals(element) || second.equals(element)));

    Assertions.assertNotNull(array.findAny(
        "First".hashCode(), (num, element) -> {
          assertIntType(num);
          assertType(element, String.class);
    ...
    Assertions.assertNotNull(array.findAnyL(
        "First".hashCode(), (num, element) -> {
          assertLongType(num);
          assertType(element, String.class);
          return num == element.hashCode();
    ...
    Assertions.assertNotNull(array.findAnyConvertedToInt("First".hashCode(), String::hashCode, NumberUtils::equals));
    ...
    Assertions.assertNotNull(array.findAnyConverted("First".hashCode(), String::hashCode, Objects::equals));
  }
  ...
  void anyMatchTest() {
    ...
    Assertions.assertFalse(array.anyMatch(
        Type1.EXAMPLE, (arg, element) -> {
          assertType(arg, Type1.class);
          assertType(element, String.class);
          return false;
    ...
    Assertions.assertFalse(array.anyMatchR(
        Type1.EXAMPLE, (element, arg) -> {
          assertType(element, String.class);
          assertType(arg, Type1.class);
          return false;
  ...
  void replaceTest() {
    ...
    Assertions.assertArrayEquals(ArrayFactory.toArray("First", "NotSecond", "Third", "  "), array.toArray());

    array.replace(3, "NotEmpty");

    Assertions.assertEquals(4, array.size());
    Assertions.assertArrayEquals(ArrayFactory.toArray("First", "NotSecond", "Third", "NotEmpty"), array.toArray());
  }
  ...
  void forEachTest() {
    ...
    array.forEachConverted(
        Type1.EXAMPLE, String::getBytes, (arg, converted) -> {
          assertType(arg, Type1.class);
    ...
    array.forEachConverted(
        Type1.EXAMPLE, Type2.EXAMPLE, String::getBytes, (arg1, arg2, converted) -> {
          assertType(arg1, Type1.class);
          assertType(arg2, Type2.class);
          assertType(converted, byte[].class);
          counter.incrementAndGet();
    ...
    array.forEach(
        "Arg", String::getBytes, (arg, element) -> {
    ...
    array.forEachR(
        Type1.EXAMPLE, Type2.EXAMPLE, (element, arg1, arg2) -> {
          assertType(element, String.class);
          assertType(arg1, Type1.class);
          assertType(arg2, Type2.class);
          counter.incrementAndGet();
    ...
    array.forEachL(
        1L, Type1.EXAMPLE, (arg1, arg2, element) -> {
          assertLongType(arg1);
    ...
    array.forEachF(
        1F, Type1.EXAMPLE, (arg1, arg2, element) -> {
    ...
    array.forEach(
        0, Type2.EXAMPLE, (arg1, arg2, element) -> {
          assertIntType(arg1);
          assertType(arg2, Type2.class);
          assertType(element, String.class);
          counter.incrementAndGet();
