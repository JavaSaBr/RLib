...
public class ObjectDictionaryTest {
  ...
  void dictionaryOfTest() {
    ...
    Assertions.assertThrows(IllegalArgumentException.class, () -> ObjectDictionary.of("Key1", 1, "Key2", 2, "Key3"));

    Assertions.assertThrows(IllegalArgumentException.class, () -> ObjectDictionary.of("Key1"));
  }
