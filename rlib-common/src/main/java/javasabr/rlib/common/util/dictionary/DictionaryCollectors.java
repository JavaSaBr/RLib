...
public final class DictionaryCollectors {
  ...
  /**
   * {@code BiConsumer<ObjectDictionary, T>} that accumulates (key, value) pairs extracted from elements into the
   * dictionary, throwing {@code IllegalStateException} if duplicate keys are encountered.
   *
  ...
  /**
   * {@code BiConsumer<LongDictionary, T>} that accumulates (key, value) pairs extracted from elements into the
   * dictionary, throwing {@code IllegalStateException} if duplicate keys are encountered.
   *
   * @param keyMapper a function that dictionaries an element into a key.
   * @param valueMapper a function that dictionaries an element into a value.
