...
public final class ArrayUtils {
   ...
   * @param factory the element's factory.
   */
  public static <T, F> void fill(T[] array, @Nullable F argument, Function<F, T> factory) {
    for (int i = 0; i < array.length; i++) {
   ...
   * @return the combined array with uniq elements.
   */
  public static <T, E extends T> T[] combineUniq(
      T @Nullable [] base,
      E @Nullable [] added,
      Class<T> type) {
   ...
   */
  public static <T> Class<T> getComponentType(T[] example) {
  ...
  public static <T> T[] create(T[] example, int size) {
    return ClassUtils.unsafeCast(java.lang.reflect.Array.newInstance(
        example
            .getClass()
  ...
  public static String toString(
      ...
      final boolean needType,
      final boolean needBrackets) {
   ...
   */
  public static <T> void forEach(T @Nullable [] array, Consumer<T> function) {
  ...
  public static <F> void forEach(
      ...
      @Nullable F argument,
      DoubleObjectConsumer<F> consumer) {
    if (array == null || array.length < 1) {
      return;
    }
   ...
   * @param consumer the consumer.
   */
  public static <T, F> void forEach(
      T @Nullable [] array,
      @Nullable F argument,
      BiConsumer<T, F> consumer) {
    if (array == null || array.length < 1) {
      return;
    }
    for (T element : array) {
   ...
   */
  public static <T, F, R> void forEach(
      T @Nullable [] array,
      @Nullable F argument,
      Function<T, @Nullable R> getElement,
      BiConsumer<R, @Nullable F> finalFunction) {
    if (array == null || array.length < 1) {
      return;
    }
    for (T element : array) {
  ...
  public static <T, F> void forEach(
      ...
      @Nullable F argument,
      Predicate<T> condition,
      BiConsumer<T, @Nullable F> function) {
    if (array == null || array.length < 1) {
      return;
    }
    for (T element : array) {
   ...
   * @param finalFunction the final function.
   */
  public static <T, R, F> void forEach(
      T @Nullable [] array,
      @Nullable F argument,
      Predicate<T> condition,
   ...
   * @param function the function.
   */
  public static <T, F, S> void forEach(
      T @Nullable [] array,
      @Nullable F first,
      @Nullable S second,
      TripleConsumer<T, F, S> function) {
    if (array == null || array.length < 1) {
      return;
    }
   ...
   * @param function the function.
   */
  public static <T, R, F, S> void forEach(
      T @Nullable [] array,
      @Nullable F first,
      @Nullable S second,
      TripleFunction<T, F, S, R> getElement,
      TripleConsumer<R, F, S> function) {
    if (array == null || array.length < 1) {
      return;
    }
    for (T element : array) {
      R subElement = getElement.apply(element, first, second);
   ...
   */
  public static <T, F> int indexOf(
      T @Nullable [] array,
      @Nullable F argument,
      BiPredicate<T, F> condition) {
  ...
  public static <T, F> int indexOf(
      T @Nullable [] array,
      @Nullable F argument,
      BiPredicate<T, @Nullable F> condition,
      int startIndex,
      int endIndex) {
    if (array == null || array.length < 1) {
      return -1;
   ...
   */
  public static <T> @Nullable T findAny(T @Nullable [] array, Predicate<? super T> condition) {
  ...
  public static <T, F> @Nullable T findAny(
      T @Nullable [] array,
      @Nullable F argument,
      BiPredicate<? super T, @Nullable F> condition) {
  ...
  public static <T, F> @Nullable T findAnyR(
      T @Nullable [] array,
      @Nullable F argument,
      BiPredicate<@Nullable F, ? super T> condition) {
  ...
  public static <T, R, F> @Nullable R findAny(
      ...
      @Nullable F argument,
      Function<T, R> getElement,
      BiPredicate<R, @Nullable F> condition) {
  ...
  public static <T, R, F> @Nullable R findAny(
      ...
      Predicate<T> condition,
      Function<T, R> getElement,
      BiPredicate<R, @Nullable F> secondCond) {
  ...
  public static <T, R> @Nullable R findL(
      ...
      Predicate<T> firstCond,
      Function<T, R> getElement,
      ObjectLongPredicate<R> secondCond) {
   ...
   * @return the element or null.
   */
  public static <T> @Nullable T findL(
      T @Nullable [] array,
      long argument,
      ObjectLongPredicate<T> condition) {
  ...
  public static <T, R> @Nullable R findL(
      ...
      long argument,
      Function<T, R> getElement,
      ObjectLongPredicate<R> condition) {
  ...
  public static <T, F, S> @Nullable T findAny(
      ...
      @Nullable F first,
      @Nullable S second,
      TriplePredicate<T, F, S> condition) {
   ...
   * @since 9.5.0
   */
  public static <T, R, M extends R> R [] map(
      T @Nullable [] source,
      Function<T, M> mapper,
      R[] def) {
    ...
    R[] resultArray = create(
        def
            .getClass()
            .getComponentType(), source.length);
   ...
   * @since 9.3.0
   */
  public static int [] longsToInts(long[] source) {
