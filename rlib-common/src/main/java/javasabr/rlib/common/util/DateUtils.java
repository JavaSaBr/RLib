...
public class DateUtils {
  ...
  public static String formatShortTimestamp(long timestamp) {
    return TIMESTAMP_FORMATTER.format(LocalDateTime.ofInstant(Instant.ofEpochMilli(timestamp), ZoneOffset.UTC));
  }
   ...
   * @since 9.3.0
   */
  public static String formatShortTimestamp(TemporalAccessor temporal) {
