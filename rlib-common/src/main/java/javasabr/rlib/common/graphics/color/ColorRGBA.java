package javasabr.rlib.common.graphics.color;
...
public final class ColorRGBA implements Cloneable, Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ColorRGBA comp)) {
      return false;
    } else if (this == o) {
      return true;
    }
    ...
    if (Float.compare(r, comp.r) != 0) {
      ...
      return Float.compare(a, comp.a) == 0;
    }
  }
  ...
  public String toString() {
    return "ColorRGBA{" + "red=" + r + ", green=" + g + ", blue=" + b + ", alpha=" + a + '}';
  }
}
