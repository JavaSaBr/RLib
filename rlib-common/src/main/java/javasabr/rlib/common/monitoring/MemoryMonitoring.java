...
public class MemoryMonitoring {
   ...
   */
  @Nullable
  private MemoryPoolMXBean findMemoryPoolMXBeen(String name) {
  ...
  private long getHeapMaxSize(MemoryUsage memoryUsage) {
  ...
  private long getHeapSize(MemoryUsage memoryUsage) {
  ...
  private double getHeapUsagePercent(MemoryUsage memoryUsage) {
  ...
  private long getHeapUsedSize(MemoryUsage memoryUsage) {
   ...
   * @return the max size.
   */
  public long getMemoryPoolMaxSize(String name) {

    MemoryPoolMXBean mxBean = findMemoryPoolMXBeen(name);
    if (mxBean == null) {
   ...
   */
  public long getMemoryPoolSize(String name) {
   ...
   */
  public long getMemoryPoolUsed(String name) {
  ...
  public String toString() {
    ...
    builder
        .append("HeapMaxSize:		")
        .append(getHeapMaxSize(memoryUsage) / 1024 / 1024)
        .append(" MiB.\n");
    builder
        .append("HeapSize:		")
        .append(getHeapSize(memoryUsage) / 1024 / 1024)
        .append(" MiB.\n");
    builder
        .append("HeapUsedSize:		")
        .append(getHeapUsedSize(memoryUsage) / 1024 / 1024)
        .append(" MiB.\n");
    builder
        .append("HeapUsagePercent:	")
        .append(getHeapUsagePercent(memoryUsage))
        .append("%.");
    ...
    for (MemoryPoolMXBean mxBeen : memoryPoolMXBeans) {

      MemoryUsage usage = mxBeen.getUsage();

      builder
          .append('\n')
          .append(mxBeen.getName())
          .append(":\n");
      builder
          .append("	")
          .append("MemoryType:	")
          .append(mxBeen.getType())
          .append('\n');
      builder
          .append("	")
          .append("MemoryMaxSize:	")
          .append(usage.getMax() / 1024 / 1024)
          .append(" MiB.\n");
      builder
          .append("	")
          .append("MemorySize:	")
          .append(usage.getCommitted() / 1024 / 1024)
          .append(" MiB.\n");
      builder
          .append("	")
          .append("MemoryUsed:	")
          .append(usage.getUsed() / 1024 / 1024)
          .append(" MiB.");
    }
