...
public class RuntimeMonitoring {
  ...
  public String toString() {
    ...
    SimpleDateFormat format = LOCAL_DATE_FORMAT.get();
    ...
    builder
        .append("	")
        .append("OS System Load:				")
        .append(operatingSystemMXBean.getSystemLoadAverage())
        .append('\n');
    builder
        .append("	")
        .append("OS Available Processors:		")
    ...
    builder
        .append("	")
        .append("JVM StartTime:				")
        .append(format.format(date))
        .append('\n');
    builder
        .append("	")
        .append("JVM UpTime:				")
        .append(runtimeMXBean.getUptime() / 1000 / 60)
        .append(" minuts")
        .append('\n');
    builder
        .append("	")
