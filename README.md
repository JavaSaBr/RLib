...
dependencies {
    compile 'com.spaceshift:rlib.common:9.1.1'
    compile 'com.spaceshift:rlib.fx:9.1.1'
    compile 'com.spaceshift:rlib.network:9.1.1'
    compile 'com.spaceshift:rlib.mail:9.1.1'
    compile 'com.spaceshift:rlib.testcontainers:9.1.1'
}
```
