 ...
 * @author Ronn
 */
public interface LExecutorService<L>
{
	/**
	 * Блокировка исполнителя на указанное время, 
	 * для завершения активных задач после выключения его.
	 * 
	 ...
	 * @throws NullPointerException
	 */
	public <T, C extends Collection<Future<T>>> C invokeAll(Collection<? extends LCallable<L, T>> tasks, C container) throws InterruptedException;
	...
	/**
	 * Запустить процесс обычного завершения работы пула, 
	 * текущие задачи будут довыполнены, новые приниматься не будут.
	 */
	public void shutdown();

	/**
	 * Произвести остановку всех активных задач, 
	 * при этом вернуть список ожидающих задач.
	 */
