...
public class FastLongTable<V> extends AbstractTable<LongKey, V> {
	...
	protected FastLongTable(final float loadFactor) {
		this(loadFactor, DEFAULT_INITIAL_CAPACITY);
	}

	@SuppressWarnings("unchecked")
	protected FastLongTable(final float loadFactor, final int initCapacity) {
	...
	protected FastLongTable(final int initCapacity) {
